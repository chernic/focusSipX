...
typedef enum pjmedia_vid_dev_wnd_flag{
    ...
    PJMEDIA_VID_DEV_WND_INPUT_GRABBED       = 4,
    PJMEDIA_VID_DEV_WND_ALWAYS_ON_TOPD      = 8,
    PJMEDIA_VID_DEV_WND_ALLOW_HIGHDPI       = 16,
    PJMEDIA_VID_DEV_WND_UTILITY             = 32,
    PJMEDIA_VID_DEV_WND_SKIP_TASKBAR        = 64,
    PJMEDIA_VID_DEV_WND_INPUT_FOCUS         = 128,
    PJMEDIA_VID_DEV_WND_MOUSE_FOCUS         = 256
...
typedef enum pjmedia_vid_dev_cap{
    ...
    PJMEDIA_VID_DEV_CAP_BUTTON_SIZE         = 1024,
    PJMEDIA_VID_DEV_CAP_PREVIW_POS          = 2048,
    PJMEDIA_VID_DEV_CAP_PREVIW_SIZE         = 4096,
    PJMEDIA_VID_DEV_CAP_STREAM_POS          = 8192,
    PJMEDIA_VID_DEV_CAP_STREAM_SIZE         = 16384,

    PJMEDIA_VID_DEV_CAP_MAX                 = 32768
...
//    pjmedia_ratio frame_rate;
    ...
    // ABChernic : previw
    pjmedia_coord     previw_pos;
    pjmedia_rect_size previw_size;
    // ABChernic : stream
    pjmedia_coord     stream_pos;
    pjmedia_rect_size stream_size;
...
PJ_DECL(pj_status_t) pjmedia_vid_dev_stream_set_cap(
                        ...
                        pjmedia_vid_dev_cap cap,
                        const void *value);
PJ_DECL(pj_status_t) pjmedia_vid_dev_stream_set_dir(
                        pjmedia_vid_dev_stream *strm,
                        const void *value);
 ...
 *                  error code.
 */
PJ_DECL(pj_status_t) pjmedia_vid_dev_stream_put_frame(pjmedia_vid_dev_stream *strm,const pjmedia_frame *frame);
