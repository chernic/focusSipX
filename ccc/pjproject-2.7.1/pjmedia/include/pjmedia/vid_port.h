...
/// ABChernic
PJ_DEF(pj_status_t) pjmedia_vid_port_set_sdl_window(pjmedia_vid_port *vid_port, void *user_data);
PJ_DEF(pj_status_t) pjmedia_vid_port_get_sdl_window(pjmedia_vid_port *vid_port, void *user_data);
/// ABChernic
