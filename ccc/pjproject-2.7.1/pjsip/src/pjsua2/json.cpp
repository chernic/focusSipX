...
// R2
static string           jsonNode_unreadName         (const ContainerNode*n)                             throw(Error);
// R3
static float            jsonNode_readNumber         (const ContainerNode*, const string&)               throw(Error);
// R4
static bool             jsonNode_readBool           (const ContainerNode*, const string&)               throw(Error);
// R5
static string           jsonNode_readString         (const ContainerNode*, const string&)               throw(Error);
// R6
static StringVector     jsonNode_readStringVector   (const ContainerNode*, const string&)               throw(Error);
// R7
static ContainerNode    jsonNode_readContainer      (const ContainerNode*, const string&)               throw(Error);
// R8
static ContainerNode    jsonNode_readArray          (const ContainerNode*, const string&)               throw(Error);

// W1
static void             jsonNode_writeNumber        (ContainerNode*,const string&,float )               throw(Error);
// W2
static void             jsonNode_writeBool          (ContainerNode*,const string&,bool )                throw(Error);
// W3
static void             jsonNode_writeString        (ContainerNode*,const string&,const string&)        throw(Error);
// W4
static void             jsonNode_writeStringVector  (ContainerNode*,const string&,const StringVector&)  throw(Error);
// W5
static ContainerNode    jsonNode_writeNewContainer  (ContainerNode*,const string&)                      throw(Error);
// W6
static ContainerNode    jsonNode_writeNewArray      (ContainerNode*,const string&)                      throw(Error);
...
static pj_status_t json_file_writer(const char *s,unsigned size,void *user_data){
...
static pj_status_t json_string_writer(const char *s,unsigned size,void *user_data){
...
static void json_verify(struct json_node_data *jdat, const char *op, const string &name, pj_json_val_type type){
...
// R2
static string           jsonNode_unreadName         (const ContainerNode *node)                                     throw(Error){
    json_node_data *jdat = (json_node_data*)&node->data;
    json_verify(jdat, "unreadName()", "", PJ_JSON_VAL_NULL);
    return pj2Str(jdat->childPtr->name);
}
// R3
static float            jsonNode_readNumber         (const ContainerNode *node,const string &name)                  throw(Error){
    json_node_data *jdat = (json_node_data*)&node->data;
...
// R4
static bool             jsonNode_readBool           (const ContainerNode *node,const string &name)                  throw(Error){
    json_node_data *jdat = (json_node_data*)&node->data;
...
// R5
static string           jsonNode_readString         (const ContainerNode *node,const string &name)                  throw(Error){
    json_node_data *jdat = (json_node_data*)&node->data;
...
// R6
static StringVector     jsonNode_readStringVector   (const ContainerNode *node, const string &name)                 throw(Error){
    json_node_data *jdat = (json_node_data*)&node->data;
...
// R7
static ContainerNode    jsonNode_readContainer      (const ContainerNode *node,const string &name)                  throw(Error){
    json_node_data *jdat = (json_node_data*)&node->data;
...
// R8
static ContainerNode    jsonNode_readArray          (const ContainerNode *node,const string &name)                  throw(Error){
    json_node_data *jdat = (json_node_data*)&node->data;
...
// W1
static void             jsonNode_writeNumber        (ContainerNode*node,const string&name,float num)                throw(Error){
    json_node_data *jdat = (json_node_data*)&node->data;
...
// W2
static void             jsonNode_writeBool          (ContainerNode*node,const string&name,bool value)               throw(Error){
    json_node_data *jdat = (json_node_data*)&node->data;
    pj_json_elem *el = jdat->doc->allocElement();
    pj_str_t nm = alloc_name(jdat->doc, name);
...
// W3
static void             jsonNode_writeString        (ContainerNode*node,const string&name,const string&value)       throw(Error){
    json_node_data *jdat = (json_node_data*)&node->data;
    pj_json_elem *el = jdat->doc->allocElement();
    pj_str_t nm = alloc_name(jdat->doc, name);
    pj_str_t new_val;
...
// W4
static void             jsonNode_writeStringVector  (ContainerNode*node,const string&name,const StringVector&value) throw(Error){
    json_node_data *jdat = (json_node_data*)&node->data;
    pj_json_elem *el = jdat->doc->allocElement();
    pj_str_t nm = alloc_name(jdat->doc, name);
...
// W5
static ContainerNode    jsonNode_writeNewContainer  (ContainerNode*node,const string&name)                          throw(Error){
    json_node_data *jdat = (json_node_data*)&node->data;
    pj_json_elem *el = jdat->doc->allocElement();
    pj_str_t nm = alloc_name(jdat->doc, name);
...
// W6
static ContainerNode    jsonNode_writeNewArray      (ContainerNode*node,const string&name)                          throw(Error){
    json_node_data *jdat = (json_node_data*)&node->data;
    pj_json_elem *el = jdat->doc->allocElement();
    pj_str_t nm = alloc_name(jdat->doc, name);
