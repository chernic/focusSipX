...
// E24----> F14
void Endpoint::on_call_replace_request2(
                        pjsua_call_id call_id,
                        pjsip_rx_data *rdata,
                        int *st_code,
                        pj_str_t *st_text,
...
// E25----> F15
void Endpoint::on_call_replaced(
...
// E01
void Endpoint::on_timer(
                        pj_timer_heap_t *timer_heap,pj_timer_entry *entry){
...
// E03
void Endpoint::on_transport_state( 
                        pjsip_transport *tp,
...
// E07
void Endpoint::on_incoming_subscribe(
                        pjsua_acc_id acc_id,
...
// E12
void Endpoint::on_acc_find_for_incoming(
...
// E14
void Endpoint::on_buddy_evsub_state(
                        pjsua_buddy_id buddy_id,
                        pjsip_evsub *sub,
                        pjsip_event *event){
    PJ_UNUSED_ARG(sub);
...
// E26
void Endpoint::on_call_rx_offer(
                        pjsua_call_id call_id,
...
// E27
void Endpoint::on_call_tx_offer(
                        pjsua_call_id call_id,
                        void *reserved,
                        pjsua_call_setting *opt){
    PJ_UNUSED_ARG(reserved);
...
// E28
pjsip_redirect_op Endpoint::on_call_redirected(
                        pjsua_call_id call_id,
...
// E30
void Endpoint::on_call_media_event(
                        pjsua_call_id call_id,
                        unsigned med_idx,
                        pjmedia_event *event){
    Call *call = Call::lookup(call_id);
...
// E32
void Endpoint::on_create_media_transport_srtp(
                        pjsua_call_id call_id,
                        unsigned media_idx,
...
// E33
void Endpoint::on_ip_change_progress(
