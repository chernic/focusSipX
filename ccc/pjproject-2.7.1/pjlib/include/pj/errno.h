 ...
 * Unknown error has been reported.
 */
#define EU_PJSUA_UN_CONSTRUCT         (PJ_ERRNO_START_USER + 1) /* 170001 */
#define EU_PJSUA_CREATE_FAILED        (PJ_ERRNO_START_USER + 2) /* 170002 */
#define EU_PJSUA_INIT_FAILED		  (PJ_ERRNO_START_USER + 3) /* 170003 */
#define EU_PJSUA_START_FAILED		  (PJ_ERRNO_START_USER + 4) /* 170004 */
#define EU_ACC_FULL					  (PJ_ERRNO_START_USER + 5) /* 170004 */
