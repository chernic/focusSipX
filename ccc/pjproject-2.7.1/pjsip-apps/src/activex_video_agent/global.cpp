...
void PJAccountConfig(pjsua_acc_config *acc_cfg){
    ...
    acc_cfg->vid_wnd_flags          = PJMEDIA_VID_DEV_WND_UTILITY | PJMEDIA_VID_DEV_WND_ALWAYS_ON_TOPD 
    | PJMEDIA_VID_DEV_WND_SKIP_TASKBAR |PJMEDIA_VID_DEV_WND_INPUT_GRABBED;

    acc_cfg->vid_stream_wnd_flags   = PJMEDIA_VID_DEV_WND_UTILITY 
    | PJMEDIA_VID_DEV_WND_ALWAYS_ON_TOPD | PJMEDIA_VID_DEV_WND_SKIP_TASKBAR;
#endif
}
