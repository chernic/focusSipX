...
//#import "C:\project\pjproject\pjsip-apps\src\activex_video_agent\activex_video_agent.tlb" raw_interfaces_only, raw_native_types, no_namespace, named_guids	//"Import typelib"

template <class T>
class CProxy_IVideoAgentEvents : public IConnectionPointImpl<T, &DIID__IVideoAgentEvents, CComDynamicUnkArray>
{
	//Warning this class may be recreated by the wizard.
public:
	VOID Fire_OnCallState(INT call_index, VideoAgent_Call_Info * pInfo)
	{
