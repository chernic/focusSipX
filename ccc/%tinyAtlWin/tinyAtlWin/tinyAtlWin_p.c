...
typedef struct _tinyAtlWin_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } tinyAtlWin_MIDL_TYPE_FORMAT_STRING;

typedef struct _tinyAtlWin_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } tinyAtlWin_MIDL_PROC_FORMAT_STRING;

typedef struct _tinyAtlWin_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } tinyAtlWin_MIDL_EXPR_FORMAT_STRING;
...
extern const tinyAtlWin_MIDL_TYPE_FORMAT_STRING tinyAtlWin__MIDL_TypeFormatString;
extern const tinyAtlWin_MIDL_PROC_FORMAT_STRING tinyAtlWin__MIDL_ProcFormatString;
extern const tinyAtlWin_MIDL_EXPR_FORMAT_STRING tinyAtlWin__MIDL_ExprFormatString;
...
extern const MIDL_SERVER_INFO InoneWin_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO InoneWin_ProxyInfo;
...
static const tinyAtlWin_MIDL_PROC_FORMAT_STRING tinyAtlWin__MIDL_ProcFormatString =
    {
        0,
        {
...
static const tinyAtlWin_MIDL_TYPE_FORMAT_STRING tinyAtlWin__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
static const MIDL_STUBLESS_PROXY_INFO IComponentRegistrar_ProxyInfo =
    {
    &Object_StubDesc,
    tinyAtlWin__MIDL_ProcFormatString.Format,
...
/* Object interface: InoneWin, ver. 0.0,
   GUID={0x9830B9D6,0x2295,0x413A,{0xAB,0xAD,0x85,0x52,0x63,0x39,0x1F,0x38}} */

#pragma code_seg(".orpc")
static const unsigned short InoneWin_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO InoneWin_ProxyInfo =
    {
    &Object_StubDesc,
    tinyAtlWin__MIDL_ProcFormatString.Format,
    &InoneWin_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO InoneWin_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    tinyAtlWin__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(9) _InoneWinProxyVtbl = 
{
    &InoneWin_ProxyInfo,
    &IID_InoneWin,
    IUnknown_QueryInterface_Proxy,
    ...
    0 /* (void *) (INT_PTR) -1 /* IDispatch::GetIDsOfNames */ ,
    0 /* IDispatch_Invoke_Proxy */ ,
    (void *) (INT_PTR) -1 /* InoneWin::showWin */ ,
    (void *) (INT_PTR) -1 /* InoneWin::hideWin */
};


static const PRPC_STUB_FUNCTION InoneWin_table[] =
{
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
...
CInterfaceStubVtbl _InoneWinStubVtbl =
{
    &IID_InoneWin,
    &InoneWin_ServerInfo,
    9,
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    tinyAtlWin__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * _tinyAtlWin_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IComponentRegistrarProxyVtbl,
    ( CInterfaceProxyVtbl *) &_InoneWinProxyVtbl,
    0
};

const CInterfaceStubVtbl * _tinyAtlWin_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IComponentRegistrarStubVtbl,
    ( CInterfaceStubVtbl *) &_InoneWinStubVtbl,
    0
...
PCInterfaceName const _tinyAtlWin_InterfaceNamesList[] = 
{
    "IComponentRegistrar",
    "InoneWin",
    0
...
const IID *  _tinyAtlWin_BaseIIDList[] = 
{
    &IID_IDispatch,
    &IID_IDispatch,
    0
...
#define _tinyAtlWin_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _tinyAtlWin, pIID, n)

int __stdcall _tinyAtlWin_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _tinyAtlWin, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _tinyAtlWin, 2, *pIndex )
    
}

const ExtendedProxyFileInfo tinyAtlWin_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _tinyAtlWin_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _tinyAtlWin_StubVtblList,
    (const PCInterfaceName * ) & _tinyAtlWin_InterfaceNamesList,
    (const IID ** ) & _tinyAtlWin_BaseIIDList,
    & _tinyAtlWin_IID_Lookup, 
    2,
    2,
