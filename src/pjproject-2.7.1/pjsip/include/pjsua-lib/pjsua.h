...
typedef struct pjsua_acc_config
{
    ...
    unsigned         vid_stream_wnd_flags;
    unsigned         vid_preview_wnd_flags;
...
PJ_DECL(pjsua_vid_win_id) pjsua_vid_stream_get_win(pjmedia_vid_dev_index id);
...
typedef struct pjsua_vid_win_info
{
     ...
     */
    pj_bool_t is_native;
    //pj_bool_t preview_is_native;
    //pj_bool_t stream_is_native;
 ...
 * @return		PJ_SUCCESS on success, or the appropriate error code.
 */
PJ_DECL(pj_status_t) pjsua_vid_win_set_dir(pjsua_vid_win_id wid,
                                           const pj_str_t *dir);
 ...
 * @return		PJ_SUCCESS on success, or the appropriate error code.
 */
PJ_DECL(pj_status_t) pjsua_vid_win_set_size       (pjsua_vid_win_id wid, const pjmedia_rect_size *size);

PJ_DECL(pj_status_t) pjsua_vid_win_set_button_size(pjsua_vid_win_id wid, const pjmedia_rect_size *size);

PJ_DECL(pj_status_t) pjsua_vid_win_set_previw_pos (pjsua_vid_win_id wid, const pjmedia_coord *pos);
PJ_DECL(pj_status_t) pjsua_vid_win_set_previw_size(pjsua_vid_win_id wid, const pjmedia_rect_size *size);

PJ_DECL(pj_status_t) pjsua_vid_win_set_stream_pos (pjsua_vid_win_id wid, const pjmedia_coord *pos);
PJ_DECL(pj_status_t) pjsua_vid_win_set_stream_size(pjsua_vid_win_id wid, const pjmedia_rect_size *size);
